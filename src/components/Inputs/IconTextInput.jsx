...
const IconTextInput = ({ label }) => {
    const [startDate, setStartDate] = useState(null);  // Use null to check if a date has been selected
    ...
    return (
        <div className="flex flex-col items-center justify-center ">
            <DatePicker
                ...
                dateFormat="MMMM d, yyyy" // Specifies how the date should appear after being picked
                placeholderText="Feedback Deadline" // Placeholder when no date is selected
            />
        </div>
    );
};
